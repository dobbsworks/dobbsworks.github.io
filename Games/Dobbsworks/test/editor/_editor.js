...
var EditorHandler = /** @class */ (function () {
    ...
    EditorHandler.prototype.Initialize = function () {
        ...
        /* ENEMY PANEL */
        var enemyTypes = [Piggle, Biggle, PorcoRosso, PorcoBlu, Snail, Prickle, PrickleEgg, PrickleShell, DrSnips, AFish, Snouter, PricklySnouter, BeeWithSunglasses, Spurpider, Shrubbert, SnowtemPole, Snoworm, BouncingSnowWorm];
        ...
        var gizmoTypes = [
            Baseball, Battery, Door, Fan, Key, Umbrella, SnailShell, Propeller, Cannon, Ring, Rocket,
            BouncePlatform, CloudPlatform, FloatingPlatform, RisingPlatform, ShakyPlatform, WeightedPlatform
        ];
        ...
        var gizmoPanel = this.CreateFloatingButtonPanel(gizmoButtons, 4, 5);
