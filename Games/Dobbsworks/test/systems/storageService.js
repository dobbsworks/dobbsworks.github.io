...
var StorageService = /** @class */ (function () {
    ...
    StorageService.IncrementDeathCounter = function (levelId) {
        var allDeathCounts = JSON.parse(localStorage.getItem("deaths") || "[]");
        var thisLevelCounter = allDeathCounts.find(function (a) { return a.levelId == levelId; });
        if (!thisLevelCounter) {
            thisLevelCounter = { levelId: levelId, deathCount: 0 };
    ...
    StorageService.PopDeathCounter = function (levelId) {
        var allDeathCounts = JSON.parse(localStorage.getItem("deaths") || "[]");
        var thisLevelCounter = allDeathCounts.find(function (a) { return a.levelId == levelId; });
        allDeathCounts = allDeathCounts.filter(function (a) { return a.levelId != levelId; });
        localStorage.setItem("deaths", JSON.stringify(allDeathCounts));
