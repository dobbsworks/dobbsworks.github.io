...
var LevelMap = /** @class */ (function () {
    ...
    LevelMap.prototype.Draw = function (camera) {
        ...
        if (player) {
            this.timerText = Utility.FramesToTimeText(player.age);
        }
        if (this.timerText && !editorHandler.isEditorAllowed && currentLevelId != -1) {
            var fontsize = 16;
            ctx.textAlign = "left";
    ...
    LevelMap.BlankOutMap = function () {
        ...
        currentMap.GetLayerList().forEach(function (layer, index) {
            var newLayer = LevelLayer.FromImportString("AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AA/AAf", index, currentMap.mapHeight, currentMap);
