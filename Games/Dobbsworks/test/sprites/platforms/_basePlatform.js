...
var BasePlatform = /** @class */ (function (_super) {
    ...
    BasePlatform.prototype.GetFrameData = function (frameNum) {
        if (this.width <= 12) {
            return [{
                    imageTile: tiles["platform"][0][this.tilesetRow],
                    xFlip: false,
                    yFlip: false,
        ...
        var frames = [{
                imageTile: tiles["platform"][1][this.tilesetRow],
                xFlip: false,
                yFlip: false,
                xOffset: 0 + this.xRenderOffset,
                yOffset: 0 + this.yRenderOffset
            }, {
                imageTile: tiles["platform"][3][this.tilesetRow],
                xFlip: false,
                yFlip: false,
        ...
        for (var x = 12; x < this.width - 12; x += 12) {
            frames.push({
                imageTile: tiles["platform"][2][this.tilesetRow],
                xFlip: false,
                yFlip: false,
