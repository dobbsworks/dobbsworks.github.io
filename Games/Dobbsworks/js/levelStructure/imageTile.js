...
var ImageTile = /** @class */ (function () {
    ...
    ImageTile.prototype.Draw = function (ctx, destX, destY, zoom, xFlip, yFlip, scale) {
        ...
        if (currentMap === null || currentMap === void 0 ? void 0 : currentMap.hasHorizontalWrap) {
            var wrapOffset = currentMap.mainLayer.tiles.length * 12;
            if (destX < 0) {
                ctx.drawImage(this.src, this.xSrc + 0.1, this.ySrc + 0.1, this.width - 0.2, this.height - 0.2, xFlip ? (-destX - this.width * zoom - wrapOffset * zoom) : (destX + wrapOffset * zoom), yFlip ? -destY - this.width * zoom : destY, this.width * zoom * scale, this.height * zoom * scale);
            }
