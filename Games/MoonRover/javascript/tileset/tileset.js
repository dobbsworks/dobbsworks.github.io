...
function InitializeTilesets() {
    let imageIds = ["player", "orangebot","tealbot","yellowbot","limebot","cyanbot","bluebot","purplecore","bluecore","limecore","orangecore","redcore","magentacore", "star", "coin", "flame", "pellets", "explosion", "shield", "achievements", "shock"];
