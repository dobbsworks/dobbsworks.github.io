var ironswornData = {
    ...
    oracles: [
        ...
        },
        {
            name: "Trouble",
            values: [
                {i: 2, val: "Outsiders rejected"},
                {i: 4, val: "Dangerous discovery"},
                {i: 6, val: "Dreadful omens"},
                {i: 8, val: "Natural disaster"},
                {i: 10, val: "Old wounds reopened"},
                {i: 12, val: "Important object is lost"},
                {i: 14, val: "Someone is captured"},
                {i: 16, val: "Mysterious phenomenon"},
                {i: 18, val: "Revolt against a leader"},
                {i: 20, val: "Vengeful outcast"},
                {i: 22, val: "Rival settlement"},
                {i: 24, val: "Nature strikes back"},
                {i: 26, val: "Someone is missing"},
                {i: 28, val: "Production halts"},
                {i: 30, val: "Mysterious murders"},
                {i: 32, val: "Debt comes due"},
                {i: 34, val: "Unjust leadership"},
                {i: 36, val: "Disastrous accident"},
                {i: 38, val: "In league with the enemy"},
                {i: 40, val: "Raiders prey on the weak"},
                {i: 42, val: "Cursed past"},
                {i: 44, val: "An innocent is accused"},
                {i: 46, val: "Corrupted by dark magic"},
                {i: 48, val: "Isolated by brutal weather"},
                {i: 50, val: "Provisions are scarce"},
                {i: 52, val: "Sickness run amok"},
                {i: 54, val: "Allies become enemies"},
                {i: 56, val: "Attack is imminent"},
                {i: 58, val: "Lost caravan"},
                {i: 60, val: "Dark secret revealed"},
                {i: 62, val: "Urgent expedition"},
                {i: 64, val: "A leader falls"},
                {i: 66, val: "Families in conflict"},
                {i: 68, val: "Incompetent leadership"},
                {i: 70, val: "Reckless warmongering"},
                {i: 72, val: "Beast on the hunt"},
                {i: 74, val: "Betrayed from within"},
                {i: 76, val: "Broken truce"},
                {i: 78, val: "Wrathful haunt"},
                {i: 80, val: "Conflict with firstborn"},
                {i: 82, val: "Trade route blocked"},
                {i: 84, val: "In the crossfire"},
                {i: 86, val: "Stranger causes discord"},
                {i: 88, val: "Important event threatened"},
                {i: 90, val: "Dangerous tradition"},
                {i: 100, val: "Roll twice"}
            ]
        },
        {
            name: "Role",
            values: [
                ...
                {i: 94, val: "Trader"},
                {i: 99, val: "Farmer"},
                {i: 100, val: "Unusual role"}
            ]
        },
        {
            name: "Goal",
            values: [
                {i: 3, val: "Obtain an object"},
                {i: 6, val: "Make an agreement"},
                {i: 9, val: "Build a relationship"},
                {i: 12, val: "Undermine a relationship"},
                {i: 15, val: "Seek a truth"},
                {i: 18, val: "Pay a debt"},
                {i: 21, val: "Refute a falsehood"},
                {i: 24, val: "Harm a rival"},
                {i: 27, val: "Cure an ill"},
                {i: 30, val: "Find a person"},
                {i: 33, val: "Find a home"},
                {i: 36, val: "Seize power"},
                {i: 39, val: "Restore a relationship"},
                {i: 42, val: "Create an item"},
                {i: 45, val: "Travel to a place"},
                {i: 48, val: "Secure provisions"},
                {i: 51, val: "Rebel against power"},
                {i: 54, val: "Collect a debt"},
                {i: 57, val: "Protect a secret"},
                {i: 60, val: "Spread faith"},
                {i: 63, val: "Enrich themselves"},
                {i: 66, val: "Protect a person"},
                {i: 69, val: "Protect the status quo"},
                {i: 72, val: "Advance status"},
                {i: 75, val: "Defend a place"},
                {i: 78, val: "Avenge a wrong"},
                {i: 81, val: "Fulfill a duty"},
                {i: 84, val: "Gain knowledge"},
                {i: 87, val: "Prove worthiness"},
                {i: 90, val: "Find redemption"},
                {i: 92, val: "Escape from something"},
                {i: 95, val: "Resolve a dispute"},
                {i: 100, val: "Roll twice"}
            ]
        },
        {
            ...
            values: [
                ...
                {i: 19, val: "Suspicious"},
                {i: 20, val: "Hostile"},
                {i: 21, val: "Hardhearted"},
                {i: 22, val: "Successful"},
                {i: 23, val: "Talented"},
                {i: 24, val: "Experienced"},
                {i: 25, val: "Deceitful"},
                {i: 26, val: "Ambitious"},
                {i: 27, val: "Aggressive"},
                {i: 28, val: "Conceited"},
                ...
                {i: 74, val: "Friendly"},
                {i: 75, val: "Wise"},
                {i: 76, val: "Influential"},
                {i: 77, val: "Young"},
                {i: 78, val: "Adventurous"},
                {i: 79, val: "Oppressed"},
                {i: 80, val: "Vengeful"},
                {i: 81, val: "Cooperative"},
                {i: 82, val: "Armored"},
                {i: 83, val: "Apathetic"},
                {i: 84, val: "Determined"},
                {i: 85, val: "Loyal"},
                ...
                {i: 91, val: "Violent"},
                {i: 92, val: "Agreeable"},
                {i: 93, val: "Hot-tempered"},
                {i: 94, val: "Stubborn"},
                {i: 95, val: "Incompetent"},
                {i: 96, val: "Greedy"},
                {i: 97, val: "Cowardly"},
                {i: 98, val: "Obsessed"},
                {i: 99, val: "Careless"},
