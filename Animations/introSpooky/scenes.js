...
function Scene1() {
    ...
    var lifeCount = [
        ...
        new StaticText("-1", 50, "white", "black", 100, 0)
    ];
...
function Scene6(panic, balloon, basket) {
    ...
    let comicPanel3 = new Rect("#401f34", 250, 37, 148, 320);
    let ground = new Rect("#3e221f", 250, 167, 148, 60);
...
function Scene13() {
    ...
    let title = "Night of the Living Dobbs";
    let num = "666";
    let color = "purple";
