...
function Scene3() {
    var cameos = [
        ...
        new StaticImage(images.doveRed, 3, -700, -100),
    ];
    sprites.push(...cameos);
    cameos.forEach(a => {
...
function Scene4() {
    ...
    for (let i = 0; i < 9; i++) {
        ...
        if (i === 0) {
            dove = new StaticImage(images.doveRed, 3, -1200 - pos * 60, 120 + (pos * 20) * sign);
        }
...
function Scene6(panic, balloon, basket) {
    ...
    let ground = new Rect("#EEEEFF", 250, 167, 148, 60);
...
function Scene13() {
    ...
    let title = "It's a Wonderful Dobbs";
    let num = "1225";
    let color = "#03c802"; //Rand(["#f6c729", "#03c802", "#04d8f7", "#f73738"])
